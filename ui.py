...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):   # initialises with type i.e Quizbrain class
        ...
        self.true_button = Button(image=right_img, highlightthickness=0, command=self.true_pressed)
    ...
    def give_feedback(self, is_right):
        ...
        self.window.after(1000, self.get_next_question)  # because we need to flash the color for a sec only
                                                         # to show if right or wrong
